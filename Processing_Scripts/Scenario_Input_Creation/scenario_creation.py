...
#  Inputs:
#  ANTH_VBS_AGERATE     {ANTH_VBS_AGERATE:10.4e}   
#  ANTH_SVOC_VOLDIST    {ANTH_SVOC_VOLDIST:10.4f}
#  ANTH_SVOC_OXRATE     {ANTH_SVOC_OXRATE:10.4f}
#  ANTH_IVOC_SC         {ANTH_IVOC_SC:10.4f}
#  ANTH_SVOC_SC         {ANTH_SVOC_SC:10.4f}
#  BB_VBS_AGERATE       {BB_VBS_AGERATE:10.4e}
#  BB_SVOC_VOLDIST      {BB_SVOC_VOLDIST:10.4f}
#  BB_SVOC_OXRATE       {BB_SVOC_OXRATE:10.4f}
#  BB_IVOC_SC           {BB_IVOC_SC:10.4f}   
#  BB_SVOC_SC           {BB_SVOC_SC:10.4f}   


BB_VBS_SCALE="1.0"
AN_VBS_SCALE="1.0"
BB_VBS_AGERATE="{BB_VBS_AGERATE:10.4e}"
AN_VBS_AGERATE="{ANTH_VBS_AGERATE:10.4e}"
BB_VBS_OXIDATE="{BB_SVOC_OXRATE:6.4f}"
AN_VBS_OXIDATE="{ANTH_SVOC_OXRATE:6.4f}"
